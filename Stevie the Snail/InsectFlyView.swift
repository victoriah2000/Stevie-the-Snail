//
// InsectFlyView.swift
// Generated by Core Animator version 1.4 on 11/16/17.
//
...
private class InsectFlyPassthroughView: UIView {
...
@IBDesignable
class InsectFlyView : UIView, CAAnimationDelegate {
	...
	func setupHierarchy() {
		...
		let mosquito__root = InsectFlyPassthroughView()
		let mosquito__xScale = InsectFlyPassthroughView()
		let mosquito__yScale = InsectFlyPassthroughView()
	...
	func addMosquitoBuzzAnimation(beginTime: CFTimeInterval, fillMode: String, removedOnCompletion: Bool, completion: ((Bool) -> Void)?) {
		...
		mosquitoTranslationXAnimation.values = [-113.068, -113.068, 586.932, 556.932, -113.000] as [Float]
		...
		mosquitoTranslationYAnimation.values = [183.118, 6.932, 216.932, 136.932, 216.000] as [Float]
